...
class FrmPeminjaman:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='Data Peminjaman Buku Perpustakaan').grid(row=15, column=7,
        ...
        Label(mainFrame, text='BUKU:').grid(row=5, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='TAHUNTERBIT:').grid(row=6, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='KATEGORI:').grid(row=7, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='PENULIS:').grid(row=8, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='PENERBIT:').grid(row=9, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='PEMINJAMAN:').grid(row=10, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='PENGEMBALIAN:').grid(row=11, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='TELAT:').grid(row=12, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='DENDA:').grid(row=13, column=0,
            sticky=W, padx=5, pady=5)
        # Textbox
        ...
        self.txtTahunterbit.grid(row=6, column=1, padx=5, pady=5)
        # Textbox
        self.txtKategori = Entry(mainFrame) 
        self.txtKategori.grid(row=7, column=1, padx=5, pady=5)
        # Textbox
        self.txtPenulis = Entry(mainFrame) 
        self.txtPenulis.grid(row=8, column=1, padx=5, pady=5)
        # Textbox
        self.txtPenerbit = Entry(mainFrame) 
        self.txtPenerbit.grid(row=9, column=1, padx=5, pady=5)
        # Textbox
        self.txtPeminjaman = Entry(mainFrame) 
        self.txtPeminjaman.grid(row=10, column=1, padx=5, pady=5)
        # Textbox
        self.txtPengembalian = Entry(mainFrame) 
        self.txtPengembalian.grid(row=11, column=1, padx=5, pady=5)
        # Textbox
        self.txtTelat = Entry(mainFrame) 
        self.txtTelat.grid(row=12, column=1, padx=5, pady=5)
        # Textbox
        self.txtDenda = Entry(mainFrame) 
        self.txtDenda.grid(row=13, column=1, padx=5, pady=5)
        # Button
        ...
        self.btnSimpan.grid(row=14, column=0, padx=5, pady=5)
        self.btnClear = Button(mainFrame, text='Clear', command=self.onClear, width=10, fg= "black", bg="yellow")
        self.btnClear.grid(row=14, column=1, padx=5, pady=5)
        self.btnHapus = Button(mainFrame, text='Hapus', command=self.onDelete, width=10, fg= "white", bg="red")
        self.btnHapus.grid(row=14, column=2, padx=5, pady=5)
        # define columns
        columns = ('idprsp','kodebuku','ida','nama','jk','alamat','buku','tahunterbit','kategori','penulis','penerbit','peminjaman','pengembalian','telat','denda')
        ...
        self.tree.heading('tahunterbit', text='TAHUN')
        self.tree.column('tahunterbit', width="50")
        ...
        self.tree.heading('telat', text='TELAT')
        self.tree.column('telat', width="50")
        self.tree.heading('denda', text='DENDA')
        self.tree.column('denda', width="60")
        # set tree position
        self.tree.place(x=0, y=500)
    ...
    def onClear(self, event=None):
        ...
        self.txtTahunterbit.insert(END,"")
    ...
    def onReload(self, event=None):
        ...
        for i, d in enumerate(parsed_data):
            self.tree.insert("", i, text="Item {}".format(i), values=(d["idprsp"],d["kodebuku"],d["ida"],d["nama"],d["jk"],d["alamat"],d["buku"],d["tahunterbit"],d["kategori"],d["penulis"],d["penerbit"],d["peminjaman"],d["pengembalian"],d["telat"],d["denda"]))
    ...
    def TampilkanData(self, event=None):
        ...
        self.txtTahunterbit.delete(0,END)
        self.txtTahunterbit.insert(END,obj.tahunterbit)
        self.txtKategori.delete(0,END)
        ...
        self.txtTelat.delete(0,END)
        self.txtTelat.insert(END,obj.telat)
        self.txtDenda.delete(0,END)
    ...
    def onSimpan(self, event=None):
        ...
        tahunterbit = self.txtTahunterbit.get()
...
if __name__ == '__main__':
    root2 = tk.Tk()
    aplikasi = FrmPeminjaman(root2, "Aplikasi Data Peminjaman Buku Perpustakaan By Rifki F")
    root2.mainloop()