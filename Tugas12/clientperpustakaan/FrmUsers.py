...
class FrmUsers:
    ...
    def aturKomponen(self):
        ...
        self.tree.heading('passwd', text='PASSWORD')
        self.tree.column('passwd', width="150")
        self.tree.heading('rolename', text='ROLENAME')
        self.tree.column('rolename', width="80")
        # set tree position
...
if __name__ == '__main__':
    root2 = tk.Tk()
    aplikasi = FrmUsers(root2, "Register Now")
    root2.mainloop()